    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative">
        <textarea
          ...
          className="w-full h-28 px-3 py-2.5 text-xs font-mono text-ghost-bright bg-void border border-void-border rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent placeholder:text-ghost-dim placeholder:font-sans disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 overflow-y-auto"
        />
