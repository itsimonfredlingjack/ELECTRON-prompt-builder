...
const statusToneStyles: Record<StatusTone, { dot: string; text: string; ring: string; pulse: string }> = {
  'is-checking': {
    dot: 'bg-warn shadow-[0_0_0_1px_rgba(184,86,28,0.32),0_0_6px_0_rgba(184,86,28,0.32)]',
    text: 'text-warn',
    ring: 'border-warn/35 bg-warn/[0.10]',
    pulse: 'animate-[sleepy-breathe_3s_ease-in-out_infinite]',
  },
  'is-offline': {
    dot: 'bg-err shadow-[0_0_0_1px_rgba(176,56,71,0.34),0_0_6px_0_rgba(176,56,71,0.32)]',
    text: 'text-err',
    ring: 'border-err/35 bg-err/[0.10]',
    pulse: 'animate-[sleepy-breathe_2.4s_ease-in-out_infinite]',
  },
  'is-ready': {
    dot: 'bg-accent-500 shadow-[0_0_0_1px_rgba(150,108,51,0.34),0_0_8px_0_rgba(150,108,51,0.40)]',
    text: 'text-accent-600',
    ring: 'border-accent-500/30 bg-accent-500/[0.10]',
    pulse: 'animate-[sleepy-breathe_5s_ease-in-out_infinite]',
  },
  'is-warming': {
    dot: 'bg-warn shadow-[0_0_0_1px_rgba(184,86,28,0.32),0_0_6px_0_rgba(184,86,28,0.28)]',
    text: 'text-warn',
  ...
  'is-idle': {
    ...
    text: 'text-ink-300',
    ring: 'border-chrome-line-2 bg-surface-750',
